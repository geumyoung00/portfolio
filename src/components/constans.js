...
const EDUCATION = [
  ...
  {
    id: '2',
    title: 'Kernel Academy React & Redux 웹 프로그래밍',
    dates: '22.08 – 10',
...
const PROJECT_LIST = [
  {
    ...
    dates: '',
    desc: '부산 테크노파크의 R&D 사업으로 진행한 자료 수집 모니터링 및 자료 관리 시스템 프로토타입 프로젝트입니다. 수집할 데이터들의 수집 주기와 수집 방법에 대해서 분류, 등록하여 관리하고 수집되는 상태와 로그를 보여줌으로써 데이터 수집을 감시합니다. 프론트엔드 개발자로서 백엔드팀과의 첫 협업으로 API 연동 과정에서 데이터 구조 정의 및 상태 관리 최적화에 대한 이해를 높일 수 있었습니다.',
